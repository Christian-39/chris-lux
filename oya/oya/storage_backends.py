...
class BackblazeB2Storage(S3Storage):
    ...
    default_acl = None          # CRITICAL: No ACL for B2
    ...
    def exists(self, name):
        ...
        B2 may return 403 if the application key lacks 'readFiles' permission.
        Treat 403 as "file does not exist" so upload can proceed.
        """
        try:
    ...
    def get_object_parameters(self, name):
        """NEVER send ACL parameters. B2 does not support per-object ACLs."""
        return {}

    def _get_write_parameters(self, name, content=None):
        """Ensure no ACL is sent with PUT/POST requests."""
